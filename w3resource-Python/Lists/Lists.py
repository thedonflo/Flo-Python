...
# sum_list = [10, 12, 20, 22]
# start = 0
# for num in sum_list:
#     start += num
# print("Sum of the listed items is {0}".format(start))
...
# items = [8, -5, 22, -3]
# items.sort()
# print("The largest number in the list is {0}".format(items[len(items)-1]))

# 4. Write a Python program to get the smallest number from a list. Go to the editor
items = [8, -5, 22, -3]
items.sort()
print("The largest number in the list is {0}".format(items[0]))
