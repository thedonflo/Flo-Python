...
#2. Given a list of words ["Elie", "Tim", "Matt"] create a variable called answer2, which is a new list with each word reversed and in
#   lower case(use a slice to do the reversal) Your output should be ['eile', 'mit', 'ttam']
