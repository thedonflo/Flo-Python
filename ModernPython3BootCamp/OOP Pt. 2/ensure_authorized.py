...
# The function passed to it should only be invoked if there exists a keyword argument
# with a name of "role" and a value of "admin".
...
def ensure_authorized(fn):
    ...
    def wrapper(*args, **kwargs):
        if isinstance(kwargs, dict) and kwargs.get('role') == 'admin': #Check if kwargs is a dict and key,value pair
