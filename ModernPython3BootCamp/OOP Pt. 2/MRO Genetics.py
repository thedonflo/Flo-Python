...
# We're going to simulate basic Mendelian inheritance in this exercise.
# You don't need to know what that means,
# but basically imagine a family where all the kids look exactly like one parent,
# maybe that parent has more "dominant" genetic traits than the other parent.
#
...
#
#
# Now define Child  to have the same attributes, eye_color , hair_color , and hair_type ,
# but don't set them on the class.
