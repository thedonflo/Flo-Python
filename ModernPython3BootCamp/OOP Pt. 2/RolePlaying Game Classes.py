...
# Side note: check out these games actually built in Python!
#
...
# 2. Define a subclass "NPC" (which stands for Non-Player Character) that inherits from Character ,
# and has an additional instance method called speak  which prints the speech that character would say when a player interacts with them.
#
# Example:
#
...
class NPC(Character):
    ...
    def speak(self):
        ...
        return "{0} says: I heard there were monsters running around last night!".format(self.name)
