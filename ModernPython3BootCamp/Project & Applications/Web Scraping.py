...
def scrape_quotes():        #Note, this function serves as a wrapper for the logic below
    ...
    return all_quotes           #return the list of quotes
...
def start_game(quotes):                               #All the logic below was first created before we wrapped in this function
    quote = choice(quotes)                              #Select a random quote. This is a dictionary as defined above
    ...
    if again.lower() in ('yes', 'y'):
        ...
        return start_game(quotes)                                                                     #Call start_game() function
    else:
        print("OK, GOODBYE!")


quotes = scrape_quotes()                                                                            #Call quotes function first
start_game(quotes)                                                                                    #Start game
