...
def display_movies_by_minutes():
    min = int(input("Maximum number of minutes: "))
    print()
    # title = 'LESS THAN '+str(min)+' MINUTES'
    movies = db.get_movies_by_minutes(min)
    display_movies(movies, 'LESS THAN '+str(min)+' MINUTES')
